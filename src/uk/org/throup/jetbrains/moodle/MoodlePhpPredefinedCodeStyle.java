...
public class MoodlePhpPredefinedCodeStyle extends PredefinedCodeStyle {
    ...
    public void apply(CodeStyleSettings codeStyleSettings) {
        ...
        PhpCodeStyleSettings phpSettings = codeStyleSettings.getCustomSettings(PhpCodeStyleSettings.class);
        ...
        CodeStyleSettings.IndentOptions indentOptions = codeStyleSettings.getIndentOptions(PhpFileType.INSTANCE);
